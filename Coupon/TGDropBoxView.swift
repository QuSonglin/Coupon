...
class TGDropBoxView: UIView {
    ...
    init(parentVC: UIViewController, title: String, items: [String], frame: CGRect) {
        ...
        //self.boxArrow = UIImageView(frame: CGRect(width: 18, height: 18))
    ...
    override func layoutSubviews() {
        ...
        self.boxTitle.frame.origin = CGPoint(x: 0, y: 0)
        self.boxTitle.font = UIFont.systemFont(ofSize: 15)
        ...
        self.boxArrow.center = CGPoint(x: self.frame.size.width - 10, y: self.frame.size.height * 0.5 + 5)
        self.boxArrow.frame.size.height = 15
        self.boxArrow.frame.size.width = 25
